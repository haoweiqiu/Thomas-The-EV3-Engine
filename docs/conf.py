...
project = u'Thomas the EV3 Engine'
copyright = u'2020, Haowei'
author = u'Haowei'
...
htmlhelp_basename = 'ThomasEnginedoc'
...
latex_documents = [
    (master_doc, 'ThomasEngine.tex', project,
...
man_pages = [
    (master_doc, 'thomasEngine', project,
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ThomasEngine', project,
     author, 'ThomasEngine', 'One line description of project.',
     'Miscellaneous'),
]
